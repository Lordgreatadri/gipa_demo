    ...
    <body>
        ...
        <header class="site-header" data-header>
            <div class="shell site-header__inner">
                ...
                <nav class="desktop-nav" aria-label="Primary navigation">
                    ...
                    <a href="{{ route('home') }}#map">Investment map</a>
                    <a href="{{ route('home') }}#districts">Districts</a>
        ...
        <footer class="site-footer">
            <div class="shell site-footer__main">
                ...
                <div class="footer-links"><strong>Explore</strong><a href="{{ route('opportunities.index') }}">Opportunities</a><a href="{{ route('home') }}#map">Investment map</a><a href="{{ route('home') }}#districts">Districts</a></div>
                ...
                <div class="footer-links"><strong>Platform</strong><a href="/api/v1/opportunities">API</a><a href="{{ route('staff.login') }}">Staff access</a><span>WCAG 2.1 AA aligned</span></div>
            </div>
